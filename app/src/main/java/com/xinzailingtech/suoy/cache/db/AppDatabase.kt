package com.xinzailingtech.suoy.cache.db
...
import com.xinzailingtech.suoy.sample.data.local.GitHubRepoDao
import com.xinzailingtech.suoy.sample.data.local.User
import com.xinzailingtech.suoy.sample.data.local.UserDao
